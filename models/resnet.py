...
def ResNet_101(num_classes=1000):
    ...
    # return torch.hub.load(local_dir, 'resnet101', source='local', pretrained=False)
    return resnet101()

def ResNet_152(num_classes=1000):
    # return ResNet(block=BottleNeck, groups=[3, 8, 36, 3], num_classes=num_classes)
    # return torch.hub.load(local_dir, 'resnet152', source='local', pretrained=False)
    return resnet152()
